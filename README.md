...
qdx/1.0.8 darwin-x64 node-v10.13.0
$ qdx --help [COMMAND]
USAGE
  $ qdx COMMAND
...
...
_See code: [src/commands/data.js](https://github.com/qislam/qdx/blob/v1.0.8/src/commands/data.js)_
...
_See code: [src/commands/deploy.js](https://github.com/qislam/qdx/blob/v1.0.8/src/commands/deploy.js)_
...
_See code: [src/commands/metapackage.js](https://github.com/qislam/qdx/blob/v1.0.8/src/commands/metapackage.js)_
...
_See code: [src/commands/package.js](https://github.com/qislam/qdx/blob/v1.0.8/src/commands/package.js)_
...
_See code: [src/commands/puppeteer.js](https://github.com/qislam/qdx/blob/v1.0.8/src/commands/puppeteer.js)_
<!-- commandsstop -->
